                        ...
                        {shukkaMesaiList.map((item, index) => (
                            <tr key={index}>
                                ...
                                <td className="number-column">
                                    <input id='suryo-detail' type="number"
                                ...
                                <td className="text-column">
                                    <input id='lot-no-detail' type="text"
                                        name='lotNo'
                                        value={item.lotNo}
                                        onChange={(event) => {
                                            handleShukkaMesaiChange(index, event.target.name, event.target.value)
                                ...
                                <td className="number-column">
                                    <input id='tanka-detail' type="number"
                                        name='tanka'
                                        value={item.tanka}
                                        onChange={(event) => {
                                            handleShukkaMesaiChange(index, event.target.name, event.target.value)
                                ...
                                <td className="text-column">
                                    <input id='memo-ran-detail' type="text" className='w-56'
                                        name='tekiyoMesai'
